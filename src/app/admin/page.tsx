...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<"users" | "reports" | "content" | "bots" | "listings" | "health">("users");
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex gap-2 mb-6 border-b border-gray-200 dark:border-gray-700 overflow-x-auto pb-1">
        {([[ "users", "👥 Kullanıcılar"], ["reports", "🚨 Şikayetler"], ["content", "📝 İçerik"], ["listings", "📋 İlanlar"], ["bots", "🤖 Botlar"], ["health", "🏥 Sistem Sağlığı"]] as const).map(([tab, label]) => (
          <button
            key={tab}
