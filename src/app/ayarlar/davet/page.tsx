    ...
    <div className="space-y-6">
      ...
      {data && (
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5 space-y-4">
          <div>
            <label className="text-sm font-medium text-gray-600 dark:text-gray-400">{t("yourCode")}</label>
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400">
            <span className="font-semibold text-gray-800 dark:text-gray-200">{data.referralCount}</span> {t("joinedCountSuffix")}
          </div>

          {/* Davet edilen kişiler */}
          {data.referrals.length > 0 && (
            <div className="space-y-2 pt-2 border-t border-gray-100 dark:border-gray-700">
              <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">{t("invitedUsers")}</p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5 space-y-3">
        <label className="text-sm font-medium text-gray-600 dark:text-gray-400">{t("haveCode")}</label>
