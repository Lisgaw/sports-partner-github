      ...
      data: {
        ...
        ...(() => {
          ...
          return {
            ...
            youtube: canSee(user.youtubeVisibility) ? (user.youtube ?? null) : null,
            linkedin: canSee(user.linkedinVisibility) ? (user.linkedin ?? null) : null,
            discord: canSee(user.discordVisibility) ? (user.discord ?? null) : null,
